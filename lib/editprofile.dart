...
class editprofile extends StatefulWidget {
  editprofile({Key key, this.lan}) : super(key: key);
  bool lan;
  @override
    ...
    return Scaffold(
      ...
      appBar:AppBar(
        ...
        title: Container(
          ...
          child: Text(widget.lan?"Edit Account" : "تعديل الحساب",textAlign: TextAlign.right,style:TextStyle(
            color:Colors.white,
            fontSize:h*0.05,
      ...
      body: ListView(
        children: [
          ...
          Container(
              ...
              child: Text(widget.lan? "Edit :" : "تعديل :", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30 ,color: Colors.deepOrange),)),
          ...
          Container(
              padding: EdgeInsets.symmetric(horizontal: 10),
              alignment: Alignment.centerLeft,
              child: Text(widget.lan? "Email :" : "البريد الالكتروني", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20 ,color: Colors.black),)),
          SizedBox(height: h*0.01,),
          Container(
            //  margin: EdgeInsets.symmetric(vertical: 10),
              padding: EdgeInsets.symmetric(horizontal: 20,vertical: 5),
              ...
              child: TextField(
                decoration: InputDecoration(
                  ...
                  hintText:widget.lan? "  Email" : "البريدالالكتروني ",
                  border: InputBorder.none,
                ),
          ...
          Container(
            ...
            child: ClipRRect(
              ...
              child: FlatButton(
                  ...
                  child: Text(widget.lan? "Edit" : "تعديل",
